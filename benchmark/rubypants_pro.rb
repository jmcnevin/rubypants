class RubyPantsPRO < String
  # ---------------------------------------------------------------------------
  # The following code is essentially identical to 'v0.7.0' tagged in the
  # repository. Only the initial comment has been replaced.
  #
  # TODO: Automate updating code here with that from future releases and update
  #       the tag-version strings in `Rakefile` and `benchmark/run.rb`
  # ---------------------------------------------------------------------------
